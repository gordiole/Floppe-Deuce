...
// FloppyDeuce.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFloppyDeuceApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CFloppyDeuceApp

CFloppyDeuceApp::CFloppyDeuceApp()
{
...
// Единственный объект CFloppyDeuceApp

CFloppyDeuceApp theApp;


// инициализация CFloppyDeuceApp

BOOL CFloppyDeuceApp::InitInstance()
{
